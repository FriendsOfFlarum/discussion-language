...
/***/ "./src/admin/components/LanguagesSettingsModal.js":
/*!********************************************************!*\
  !*** ./src/admin/components/LanguagesSettingsModal.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LanguagesSettingsModal; });
...
var LanguagesSettingsModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_2__["default"])(LanguagesSettingsModal, _Modal);

  function LanguagesSettingsModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = LanguagesSettingsModal.prototype;
  ...
  _proto.content = function content() {
    ...
    return [m("div", {
    ...
    }, m("label", null, "Locale"), m("div", null, m("input", {
      ...
      className: "Form-group"
    }, app.store.all('discussion-languages').map(function (language) {
      return flarum_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
        className: 'Button Button--link',
        children: m("code", null, language.code()),
        onclick: _this.remove.bind(_this, language),
        loading: _this.deleting[language.id()]
      });
    })))];
  };
  ...
  _proto.add = function add() {
    ...
    this.adding = true;
    var code = this.newLocale();
    var language = app.store.createRecord('discussion-languages');
    language.save({
      code: code
    }).then(function () {
      _this2.newLocale('');
      ...
      return _this2.adding = false;
    });
  };

  _proto.remove = /*#__PURE__*/function () {
    var _remove = Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(language) {
      var _this3 = this;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              language["delete"]().then(function () {
                return delete _this3.deleting[language.id()];
              })["catch"](function () {
                return delete _this3.deleting[language.id()];
              }).then(function () {
                return m.redraw();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var flarum_models_Forum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/models/Forum */ "flarum/models/Forum");
/* harmony import */ var flarum_models_Forum__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_models_Forum__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_LanguagesSettingsModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/LanguagesSettingsModal */ "./src/admin/components/LanguagesSettingsModal.js");
/* harmony import */ var _common_models_Language__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/models/Language */ "./src/common/models/Language.js");



app.initializers.add('fof/discussion-language', function () {
  app.store.models['discussion-languages'] = _common_models_Language__WEBPACK_IMPORTED_MODULE_2__["default"];
  flarum_models_Forum__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.discussionLanguages = flarum_models_Forum__WEBPACK_IMPORTED_MODULE_0___default.a.hasMany('discussionLanguages');

  app.extensionSettings['fof-discussion-language'] = function () {
    return app.modal.show(new _components_LanguagesSettingsModal__WEBPACK_IMPORTED_MODULE_1__["default"]());
  };
});
